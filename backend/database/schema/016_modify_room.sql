...
ALTER TABLE room ADD COLUMN feedback VARCHAR(500);
ALTER TABLE room ADD COLUMN passed BOOLEAN CHECK ( passed IS NOT NULL OR status != 'completed' );
...
ALTER TABLE room DROP COLUMN feedback;
ALTER TABLE room DROP COLUMN passed;
