    ...
    return (
        <div className="flex flex-col items-center justify-center md:flex-row min-h-screen">
            <div className="flex flex-col max-w-[650px]  w-full ">
                ...
                <p className="w-[45ch] my-4 text-(--text-secondary) text-center md:text-left">Devora lets companies run live coding interviews with built-in video calls, collaborative coding environments, and structured challenges</p>
