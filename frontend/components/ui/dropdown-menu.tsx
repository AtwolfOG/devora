  ...
  return (
    <MenuPrimitive.Portal>
      <MenuPrimitive.Positioner
        className="isolate z-50 outline-none! border-none!"
        align={align}
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn("bg-(--bg-muted)! border border-(--border)! z-50 max-h-(--available-height) w-(--anchor-width) min-w-32 origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-lg p-1 text-(--text-primary) shadow-md duration-100 outline-none data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:overflow-hidden data-closed:fade-out-0 data-closed:zoom-out-95 dark:bg-(--bg-muted) dark:text-(--text-primary)", className )}
          {...props}
        />
      </MenuPrimitive.Positioner>
    </MenuPrimitive.Portal>
...
function DropdownMenuSeparator({
  ...
  return (
    <MenuPrimitive.Separator
      ...
      className={cn("-mx-1 my-1 h-[2px] bg-(--bg-light)! dark:bg-oklch(1 0 0 / 10%)", className)}
      {...props}
    />
  )
}
