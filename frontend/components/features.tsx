...
const featuresData: featureType[] = [
    ...
    },
    {
        ...
        badge: "CHALLENGES",
        list: [ "Custom problem statements", "Test cases", "deifficulty levels", "Automatic evaluation"],
...
export default function Features() {
    ...
    return (
        <div ref={divRef} className="h-dvh w-full bg-(--bg-light)">
            {
...
function Feature({src, alt, title, subtitle, list, badge}: featureType){
    return(
        <div className="h-full max-w-[1440px] grid grid-cols-1 md:grid-cols-2 justify-center items-center">
             <div className="image-wrapper w-[90%] justify-self-center md:justify-self-end aspect-video items-center relative ">
                <Image src={src} alt={alt} fill />
             </div>
             <div className="card w-[85%] sm:w-[80%] pl-8 pr-4 py-10  max-w-[400px] border border-(--border-light) shadow-2xl/70 rounded-4xl flex flex-col justify-self-center">
