...
export default function FeedbackForm({feedback, isOwner}: {feedback: string | null, isOwner: boolean}){
    return (
        <div className="flex flex-col items-center w-full mt-12">
            <p className="self-start text-sm!">Provide your final feedback, this should be no more than 150 characters.</p>
            <textarea className="px-4 py-2 w-full mx-auto text-sm!" placeholder="feedback..."  maxLength={150} rows={7} cols={5} value={feedback || ""} disabled={!isOwner}>

            </textarea>
            {isOwner && <div className="flex items-center gap-2 mt-8">
